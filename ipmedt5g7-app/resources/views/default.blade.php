    ...
    <header id="js--mainHeader" class="mainHeader u-main-gradient u-box-shadow">
        <nav id="js--nav" class="nav">
            ...
            <ul class="nav__list">
                ...
                <li class="nav__list__li" ><p class="nav__mijnaccount--message">Hallo {{$ActiveUser->name}}</p></li>
                <li class="nav__list__li" ><a href="/gebruiker" class="nav__mijnaccount nav__mijnaccount__link" href="/gebruiker">Andere gebruiker</a></li>
            </ul> 
        </nav>
    </header>   
    @yield('content')
